...
## Save resutls
mdict = {
    'RMS_rho01_loss':history.history['loss'],
    'RMS_rho01_val_loss':history.history['val_loss'],
    'RMS_rho01_accuracy':history.history['accuracy'],
    'RMS_rho01_val_accuracy':history.history['val_accuracy']
}
savemat("Task3_1_RMS_rho01.mat", appendmat=True, mdict=mdict)