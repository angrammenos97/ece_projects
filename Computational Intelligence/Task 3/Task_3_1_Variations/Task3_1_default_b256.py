...
## Save resutls
mdict = {
    'default_b256_loss':history.history['loss'],
    'default_b256_val_loss':history.history['val_loss'],
    'default_b256_accuracy':history.history['accuracy'],
    'default_b256_val_accuracy':history.history['val_accuracy']
}
savemat("Task3_1_default_b256.mat", appendmat=True, mdict=mdict)