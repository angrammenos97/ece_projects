...
## Save resutls
mdict = {
    'drop_l1_loss':history.history['loss'],
    'drop_l1_val_loss':history.history['val_loss'],
    'drop_l1_accuracy':history.history['accuracy'],
    'drop_l1_val_accuracy':history.history['val_accuracy']
}
savemat("Task3_1_drop_l1.mat", appendmat=True, mdict=mdict)