...
## Save resutls
mdict = {
    'SGD_l2_01_loss':history.history['loss'],
    'SGD_l2_01_val_loss':history.history['val_loss'],
    'SGD_l2_01_accuracy':history.history['accuracy'],
    'SGD_l2_01_val_accuracy':history.history['val_accuracy']
}
savemat("Task3_1_SGD_l2_01.mat", appendmat=True, mdict=mdict)