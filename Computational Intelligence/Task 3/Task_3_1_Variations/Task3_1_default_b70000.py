...
## Save resutls
mdict = {
    'default_b70000_loss':history.history['loss'],
    'default_b70000_val_loss':history.history['val_loss'],
    'default_b70000_accuracy':history.history['accuracy'],
    'default_b70000_val_accuracy':history.history['val_accuracy']
}
savemat("Task3_1_default_b70000.mat", appendmat=True, mdict=mdict)