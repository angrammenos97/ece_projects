...
## Save resutls
mdict = {
    'SGD_l2_001_loss':history.history['loss'],
    'SGD_l2_001_val_loss':history.history['val_loss'],
    'SGD_l2_001_accuracy':history.history['accuracy'],
    'SGD_l2_001_val_accuracy':history.history['val_accuracy']
}
savemat("Task3_1_SGD_l2_001.mat", appendmat=True, mdict=mdict)