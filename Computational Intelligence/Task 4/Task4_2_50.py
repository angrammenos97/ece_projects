...
## Training parameters.
samples_percent = 0.5 # percentage of the dataset to use as number of units in RBF Layer
batch_size = 4
epochs = 100
verbose = 1
...
## Save results.
mdict = {
    'loss_50':history.history['loss'],
    'val_loss_50':history.history['val_loss'],
    "rmse_50":rmse,
    "r2_50":r2
}
savemat("Task4_2_50.mat", appendmat=True, mdict=mdict)