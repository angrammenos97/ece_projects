...
## Training parameters.
samples_percent = 0.9 # percentage of the dataset to use as number of units in RBF Layer
batch_size = 6
epochs = 100
verbose = 1
...
## Save results.
mdict = {
    'loss_90':history.history['loss'],
    'val_loss_90':history.history['val_loss'],
    "rmse_90":rmse,
    "r2_90":r2
}
savemat("Task4_2_90.mat", appendmat=True, mdict=mdict)