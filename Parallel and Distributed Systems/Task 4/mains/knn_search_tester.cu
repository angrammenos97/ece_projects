...
#define MatrixOrder 2	// COLMAJOR | ROWMAJOR | 2 = Check both
...
int main(int argc, char *argv[])
{
	...
	if (vr) {
		...
		gettimeofday(&startwtime, NULL);
		int isValid = (ap == 2) ? validateResult(knnres, corpus, query, n, m, d, k, COLMAJOR) || validateResult(knnres, corpus, query, n, m, d, k, ROWMAJOR)
